...
describe("MRB — golden table", () => {
  const cases: Array<{
    ...
    // Petrol/Overijssel @ 1500kg: rijksdeel 167.86/q (Art. 23) × 1.0 × (1+0.822) × 4.
    { name: "Petrol 1500kg Overijssel 2026", weightKg: 1500, p: "petrol", province: "Overijssel", taxYear: 2026, expected: 167.86 * 1 * 1.822 * 4 },
    // Diesel/Overijssel @ 1500kg: × 1.30.
    { name: "Diesel 1500kg Overijssel 2026", weightKg: 1500, p: "diesel", province: "Overijssel", taxYear: 2026, expected: 167.86 * 1.3 * 1.822 * 4 },
    // LPG/Overijssel @ 1500kg: × 1.40.
    { name: "LPG 1500kg Overijssel 2026", weightKg: 1500, p: "lpg", province: "Overijssel", taxYear: 2026, expected: 167.86 * 1.4 * 1.822 * 4 },
    // EV/Overijssel @ 1500kg in 2026: full rate × (1−0.30) korting (art. 23b → pay 70%).
    { name: "EV 1500kg Overijssel 2026", weightKg: 1500, p: "ev", province: "Overijssel", taxYear: 2026, expected: 167.86 * 1.822 * 4 * 0.7 },
    // EV/Overijssel @ 1500kg in 2030: 0% korting.
    { name: "EV 1500kg Overijssel 2030", weightKg: 1500, p: "ev", province: "Overijssel", taxYear: 2030, expected: 167.86 * 1.822 * 4 * 1.0 },
    // Different province: Zuid-Holland has highest opcenten (1.044); Groningen 0.957.
    { name: "Petrol 1500kg Groningen", weightKg: 1500, p: "petrol", province: "Groningen", taxYear: 2026, expected: 167.86 * 1 * 1.957 * 4 },
    { name: "Petrol 1500kg Noord-Holland (lowest)", weightKg: 1500, p: "petrol", province: "Noord-Holland", taxYear: 2026, expected: 167.86 * 1 * 1.821 * 4 },
    // Light car: tier 29.12/q for 600kg.
    { name: "Petrol 600kg Overijssel", weightKg: 600, p: "petrol", province: "Overijssel", taxYear: 2026, expected: 29.12 * 1 * 1.822 * 4 },
    // Heavy car: tier 426.91/q for 3000kg.
    { name: "Petrol 3000kg Overijssel", weightKg: 3000, p: "petrol", province: "Overijssel", taxYear: 2026, expected: 426.91 * 1 * 1.822 * 4 },
  ];
